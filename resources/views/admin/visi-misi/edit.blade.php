                    ...
                    <form method="POST" action="/admin/visi-misi/{{ $visiMisi->id }}">
                        ...
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="editorVisi" name="visi" rows="5">{{ old('visi', $visiMisi->visi) }}</textarea>
                                @error('visi')
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="editorMisi" name="misi" rows="5">{{ old('misi', $visiMisi->misi) }}</textarea>
                                @error('misi')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
