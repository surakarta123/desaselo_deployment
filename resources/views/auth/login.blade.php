        ...
        <div class="card-body p-5">
            <div class="text-center mb-4">
                <a href="/" class="d-block">
                    <img src="admin/assets/images/auth/LOGOSELO.png" width="180" alt="Logo">
                </a>
            </div>
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="{{ route('password.request') }}" class="text-decoration-none text-primary fw-bold">Lupa Password?</a>
                </div>
            ...
            <div class="text-center mt-3">
                ...
                <a href="{{ route('register') }}" class="btn btn-outline-primary w-100 py-2 rounded">Register</a>
            </div>
