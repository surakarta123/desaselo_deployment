...
// Admin Buku Tamu Routes
Route::get('/admin/buku-tamu', [AdminGuestbookController::class, 'index'])->name('admin.guestbook.index');
Route::delete('/admin/buku-tamu/{guestbook}', [AdminGuestbookController::class, 'destroy'])->name('admin.guestbook.destroy');
